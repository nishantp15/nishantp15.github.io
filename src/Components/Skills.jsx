  ...
  return (
    <div id="skills">
      ...
      <div className="Skills-Display">
        {languages.map((ele,i) => {
          return (
            <div key={i+1} className="skills-card Individual-Skill-Container">
              <div className="Tech-Image">
                <img className="skills-card-img" src={ele.img} alt="Img" />
              </div>
              <div>
                <h4 className="skills-card-name"> {ele.techname} </h4>
              </div>
            </div>
          );
        })}
      ...
      <div className="Skills-Display">
        {frontendFrameworks.map((ele,i) => {
          return (
            <div key={i+1} className="skills-card Individual-Skill-Container">
              <div className="Tech-Image">
                <img className="skills-card-img" src={ele.img} alt="" />
              </div>
              <div>
                <h4 className="skills-card-name"> {ele.techname} </h4>
              </div>
